      ...
      <div v-if="selectedOrder" class="product_content">
        ...
        <div class="btn_add__product">
          <div class="btn_add__img">
            <svg>
              <use xlink:href="../assets/images/sprite/add-sprite.svg#add"></use>
            </svg>
          </div>
          <span class="btn_add__text text-success">{{$t('product.add')}}</span>
        </div>
        <div>
          <div v-for="(product) in getExpandedOrderProducts" :key="product.id" class="product_block">
            <div class="product_img">
              <img :src="product.photo" :alt="product.type" v-if="imageExists(product.photo)" />
