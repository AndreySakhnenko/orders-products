...
<template>
  <div class="registration">
    ...
    <div v-if="isActive" class="registration_container">
      ...
      <a class="registration_top__link" @click="toggleLogin">{{$t('link.oldUser')}}</a>
      </div>
...
<label class="form_label">
  {{$t('form.password')}}
      ...
      <b-button class="registration_btn" variant="primary" @click.prevent="handleClick()">{{$t("btn.signUp")}}</b-button>
    </b-form>
    </div>
